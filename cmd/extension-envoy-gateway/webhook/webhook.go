...
import (
	...
	admissionvalidator "github.com/gardener/gardener-extension-envoy-gateway/pkg/admission/validator"
	...
	cmd := &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Value:       "gardener-extension-envoy-gateway",
