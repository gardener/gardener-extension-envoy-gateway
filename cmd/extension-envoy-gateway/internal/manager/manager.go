...
import (
	...
	extenimagev "github.com/gardener/gardener-extension-envoy-gateway/imagevector"
	"github.com/gardener/gardener-extension-envoy-gateway/pkg/actuator"
	configinstall "github.com/gardener/gardener-extension-envoy-gateway/pkg/apis/config/install"
	"github.com/gardener/gardener-extension-envoy-gateway/pkg/controller"
	"github.com/gardener/gardener-extension-envoy-gateway/pkg/heartbeat"
	"github.com/gardener/gardener-extension-envoy-gateway/pkg/mgr"
)

const extensionName = "gardener-extension-envoy-gateway"
	...
	cmd := &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Value:       "gardener-extension-envoy-gateway-leader-election",
